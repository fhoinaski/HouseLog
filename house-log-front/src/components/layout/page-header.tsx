    ...
    <header className={cn(pageHeaderVariants({ density, className }))} {...props}>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div className="min-w-0 space-y-1">
          {eyebrow && (
            <p className="text-xs font-medium uppercase tracking-[0.12em] text-hl-text-muted">
              {eyebrow}
            </p>
          )}
          <h1 className="text-xl font-medium leading-tight text-hl-text sm:text-2xl">{title}</h1>
