      ...
      <Card variant="tonal" density="comfortable">
        <CardContent className="space-y-3">
          <div className="flex items-start gap-3 rounded-[var(--hl-radius-card)] bg-hl-surface-muted p-4">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[var(--hl-radius-control)] bg-[color-mix(in_srgb,var(--hl-success)_12%,var(--hl-surface))] text-hl-success">
              <WalletCards className="h-5 w-5" />
            </div>
            <div className="min-w-0">
              <p className="text-sm font-medium text-hl-text">Custos vinculados ao prontuário</p>
          ...
          {isLoading ? (
            ...
            <div className="rounded-[var(--hl-radius-card)] bg-hl-surface-muted p-6 text-center">
              <ReceiptText className="mx-auto h-8 w-8 text-hl-text-muted" />
              <p className="mt-3 text-sm font-medium text-hl-text">Nenhum imóvel para financeiro</p>
              <p className="mt-1 text-sm leading-6 text-hl-text-muted">
