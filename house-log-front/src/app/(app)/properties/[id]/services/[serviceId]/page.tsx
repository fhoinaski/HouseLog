...
export default function ServiceDetailPage({
  ...
  if (!order) {
    return (
      <div className="mx-auto max-w-3xl space-y-6 px-4 py-4 safe-bottom sm:px-5 sm:py-5">
        <PageHeader
          density="editorial"
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 px-4 py-4 safe-bottom sm:px-5 sm:py-5">
      <PageHeader
        density="editorial"
        eyebrow="Ordem de servico"
        title={order.title}
